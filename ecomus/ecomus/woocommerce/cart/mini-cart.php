					...
					<div class="woocommerce-mini-cart-item__summary">
						<div class="woocommerce-mini-cart-item__box">
							<span class="woocommerce-mini-cart-item__data">
								...
								?>
								<?php if( $_product->get_sale_price() || floatval( $_product_regular_price ) > floatval( $_product->get_price() ) ) : ?>
									<span class="price"><?php echo wc_format_sale_price( $_product_regular_price, $product_price ); ?></span>
								<?php else : ?>
