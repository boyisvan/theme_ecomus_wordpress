					...
					<div class="product-inner">
						...
						<?php
							if ( ! $product_permalink ) {
								echo wp_kses_post( sprintf( '<span class="woocommerce-LoopProduct-link woocommerce-loop-product__link">%s</span>', $_product->get_image() ) );
							} else {
								echo wp_kses_post( sprintf( '<a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="%s">%s</a>', esc_url( $product_permalink ), $_product->get_image() ) );
							}
