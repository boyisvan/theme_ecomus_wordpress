...
class Dynamic_CSS {
	...
	public function add_static_css() {
		...
		$parse_css .= $this->second_color_static_css();
	 ...
	 * @return string
	 */
	protected function second_color_static_css() {
		$static_css = '';

		$second_color = Helper::get_option('second_color');
		if( ! empty( $second_color ) && $second_color !== '#000000' ) {
			$custom_color = Helper::get_option( 'second_color_custom' ) ? Helper::get_option('second_color_custom_color') : $second_color;
			$static_css = $custom_color ? '--em-color__second:' . $custom_color . '; --em-color__dark:' . $custom_color . '; --em-button-bg-color:' . $custom_color . '; --em-button-bg-color-hover:' . $custom_color . '; --em-link-color:' . $custom_color . '; --em-heading-color:' . $custom_color . ';' . '--em-button-border-color:' . $custom_color . ';' . '--em-button-border-color-hover:' . $custom_color . ';' : '';
		}
	...
	protected function typography_css() {
		$settings = array(
			...
			'typo_product_title'     		=> '.single-product div.product h1.product_title',
		);
			...
			foreach ( $properties as $key => $property ) {
				...
				if ( isset( $typography[ $key ] ) && ! empty( $typography[ $key ] ) ) {
					...
					if( $selector == 'heading' ) {
						...
						$property = 'variant' == $property ? '--em-heading-font-weight' : $property;
	...
	protected function header_static_css() {
		...
		if( $main_color = \Ecomus\Helper::get_option('header_main_text_color') ) {
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-main { --em-color__dark: ' . $main_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-main { --em-color__base: ' . $main_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-main { --em-link-color: ' . $main_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-main { color: ' . $main_color . '; }';
		}
		...
		if( $bottom_color = \Ecomus\Helper::get_option('header_bottom_text_color') ) {
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-bottom { --em-color__dark: ' . $bottom_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-bottom { --em-color__base: ' . $bottom_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-bottom { --em-link-color: ' . $bottom_color . '; }';
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-bottom { color: ' . $bottom_color . '; }';
		}
		if( $bottom_border_color = \Ecomus\Helper::get_option('header_bottom_border_color') ) {
			$static_css .= 'body:not(.header-transparent) .site-header__desktop .header-bottom { --em-border-color: ' . $bottom_border_color . '; }';
		}
	...
	protected function topbar_static_css() {
		...
		if( $background_color = \Ecomus\Helper::get_option('topbar_background_color') ) {
			...
			$static_css .= '.topbar { border-bottom: none; }';
		}
