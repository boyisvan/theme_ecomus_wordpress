...
class Quick_View extends \Ecomus\WooCommerce\Single_Product\Product_Base {
	...
	public function __construct() {
		...
		add_action('ecomus_mini_cart_products_recommended_loop_after', array( $this, 'quick_view_button_icon_dark' ));
	}
	...
	public function render_product_card() {
		switch ( \Ecomus\WooCommerce\Helper::get_product_card_layout() ) {
			...
			case 'list':
				add_action( 'woocommerce_after_shop_loop_item', array( $this, 'quick_view_button_icon_light' ), 45 );
				break;
