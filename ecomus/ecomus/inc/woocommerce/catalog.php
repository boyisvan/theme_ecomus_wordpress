...
class Catalog {
	...
	public function __construct() {
		...
		//add_action( 'ecomus_after_close_site_footer', array( $this, 'orderby_list' ) );
	...
	public function body_class( $classes ) {
		...
		$catalog_view  = $this->catalog_toolbar_default_view();

		$classes[] = 'catalog-view-' . $catalog_view;
	...
	public function top_categories() {
		...
		foreach( $terms as $term ) {
			...
			$ouput[] = sprintf(
						'<div class="catalog-top-categories__item swiper-slide %s"><a class="catalog-top-categories__inner em-ratio em-eff-img-zoom em-image-rounded" href="%s">
							%s
							<span class="catalog-top-categories__title em-button em-button-light em-font-medium"><span class="catalog-top-categories__text">%s</span>%s</span>
						</a></div>',
		...
		echo sprintf(
				'<div class="catalog-top-categories em-ratio--portrait swiper ecomus-carousel--elementor navigation-class-arrows navigation-class--tabletdots" data-spacing="30">
