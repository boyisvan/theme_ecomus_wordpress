...
final class Theme {
	 ...
	 * If you're building a theme based on ecomus, use a find and replace
	 * to change  'ecomus' to the name of your theme in all the template files.
	 */
		load_theme_textdomain( 'ecomus', get_template_directory() . '/lang' );
