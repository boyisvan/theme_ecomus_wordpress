...
class Options {
	...
	public function customize_settings() {
		...
		$sections = array(
			...
			'header_counter_background'       => array(
				'title'    => esc_html__( 'Counter Background', 'ecomus' ),
				'panel'    => 'header',
			),
			// Blog
			'post_card'       => array(
			...
			'header_mobile_logo'        => array(
				'title'    => esc_html__( 'Header Logo', 'ecomus' ),
				'panel'    => 'mobile',
			),
		...
		$settings['color_scheme'] = array(
			...
			'second_color_hr'    => array(
				'type'    => 'custom',
				'default' => '<hr/>',
			),
			'second_color_title'  => array(
				'type'  => 'custom',
				'label' => esc_html__( 'Secondary Color', 'ecomus' ),
			),
			'second_color'  => array(
				'type'            => 'color',
		...
		$settings['header_search'] = array(
			...
			'header_search_trending' => array(
				...
				'description'     => esc_html__( 'Display a list of links before searching', 'ecomus' ),
				'default'         => false,
				'priority' => 115
			),
			'header_search_links'       => array(
				...
				'active_callback' => array(
					array(
						'setting'  => 'header_search_trending',
						'operator' => '==',
						'value'    => true,
					),
				),
		...
		// Counter background
		$settings['header_counter_background'] = array(
		...
		$settings['mobile_product_catalog'] = array(
			'mobile_product_grid_hr'  => array(
				'type'            => 'custom',
				'default'         => '<h2>'. esc_html__( 'Product Grid', 'ecomus' ) .'</h2>',
			),
	...
	public static function customizer_fonts_choices() {
		$custom_fonts = apply_filters( 'ecomus_custom_fonts_options', array(
			'families' => array(
